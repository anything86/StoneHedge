...
/datum/outfit/job/roguetown/bandit/knave/pre_equip(mob/living/carbon/human/H)
	...
	switch(weapon_choice)
		if("Crossbow & Dagger") //Rogue
			...
			H.mind.adjust_skillrank_up(/datum/skill/combat/knives, 1, TRUE)
			H.mind.adjust_skillrank_up(/datum/skill/combat/crossbows, 1, TRUE)
		...
		if("Bow & Sword") //Poacher
			...
			H.mind.adjust_skillrank_up(/datum/skill/combat/bows, 1, TRUE)
			H.mind.adjust_skillrank_up(/datum/skill/combat/swords, 1, TRUE)
